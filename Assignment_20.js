...
var countries = ["England", "Italy", "Turkey", "South Korea", "Brazil"];
console.log("List Of Countries:");
console.log("------------------");
countries.map(function (items) { return console.log(items); }); 
//map method is used to read elements of an array one by one and it in a new variable here, it is named as items then all these elemetns are stored in this variable after this this sign => is used then print the new variable using console.log
