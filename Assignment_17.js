...
var Guest_list = ["Yoon Jeonghan", "Hong Joshua", "Kim Mingyu", "Min Yoongi", "Song Joongki", "Park Hyungsik", "Jeon Jungkook", "Kim Seokjin"];
...
while (Guest_list.length > 2) {
    ...
    console.log("\n\n Sorry Mr. ".concat(remove_guest, ", but I cannot invite you for the dinner"));
}

// Printing a message to the remaining 2 guests
for (var i = 0; i < Guest_list.length; i++) {
    console.log("\n\nMr. ".concat(Guest_list[i], ", you are still invited for the dinner\n\n Thank You"));
}
